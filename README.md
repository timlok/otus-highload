...
На текущий момент, кластер active/active и единственный ресурс, это клонированный ip. Необходим одновременной корректной работы двух web-фронтендов zabbix с одним процессом zabbix-server, для корректной обработки данных от агентов и для корректного обращения к БД.
